...
{   
    ...
    for(;;)
    {
        ...
        // digitaali-arvojen haku sensorilta
        reflectance_digital(&dig); 
        //print out 0 or 1 according to results of reflectance period
       printf("%5d %5d %5d %5d %5d %5d \r\n", dig.l3, dig.l2, dig.l1, dig.r1, dig.r2, dig.r3);        
        ...
        //Tänne suunnan selvitys ja moottorin työskentely
        
        //Ekana suoralla ajon korjausliikkeet
        ...
        if (dig.l1 == 1 && dig.r1 == 1) {
            ...
            //tarkistetaan pitääkö kääntyä
            if (dig.l2 == 1 && dig.r2 == 0) {
                if (dig.l3 == 1) {
                    //Käänny tiukasti vasemmalle
                    motor_turn(0, 80, 2);
                    continue;
                    
                } else {
                    //Käänny loivasti vasemmalle
                    motor_turn(30, 80, 2);
                    continue;
                }
                ...
                if (dig.r3 ==1) {
                    //Käänny tiukasti oikealle
                    motor_turn(80, 0, 2);
                    continue;
                    
                } else {
                    //Käänny loivasti oikealle
                    motor_turn(80, 30, 2);
                    continue;
